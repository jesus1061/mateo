    ...
    <div class="contenedor-dinamico-admin">
      <div class="contenedor-ajustado">
       <div  id="formulario-blog">
        ...
        <form action="banner/crear_banner" method="post" class="formulario">
         ...
         <div class="form-control">
          ...
          <br>
          <br>
          <input type="text" class="input-form" id="nombre_banner"  name="banner_nombre" placeholder="Titulo del banner" required>
        ...
        <div class="form-control">
          ...
          <br>
          <br>
          <input type="text" id="btn-abrir-multimedia" name="banner_imagen"  placeholder="Seleccionar archivo multimedia"   required  class="input-form"  style="background-color: gray; color: white; font-weight: 900; cursor: pointer" readonly>
       ...
       <input type="hidden" class="tipo-banner" name="tipo_banner" >





       <center><input type="button" id="btn-activar-formulario" value="Crear Banner" style="display:block;"></center> 
     </form>
   </div>
