  ...
  <div class="container">
    ...
    <div class="contenedor-dinamico-admin">
      <div class="contenedor-ajustado">
       <div  id="formulario-blog">
        ...
        <form action="guardar_elemento" method="post" class="formulario">
         ...
         <div class="form-control">
          ...
          <br>
          <br>
          <input type="text" class="input-form" id="nombre_banner"  name="contenido_galeria_nombre" placeholder="Nombre del elemento de galeria" required>
        ...
        <div class="form-control">
          ...
          <br>
          <br>
          <input type="text" id="btn-abrir-multimedia" name="contenido_galeria_foto"  placeholder="Seleccionar archivo multimedia"   required  class="input-form"  style="background-color: gray; color: white; font-weight: 900; cursor: pointer" readonly>
       ...
       <center><input type="button" id="btn-activar-formulario" value="Crear elemento" style="display:block;"></center> 
     </form>
   </div>
...
<script>
  $(document).ready(function(){
    ...
    $("#btn-activar-formulario").click(function(){
      if($("#nombre_banner").val().length < 1  || validacion_banner == 0  || validacion_album == 0){
