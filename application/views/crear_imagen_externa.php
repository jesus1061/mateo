      ...
      <div class="contenedor-ajustado">
        <div id="formulario-archivos">
          ...
          <div class="archivos-subida">
            <form action="subir_imagen_externa" enctype="multipart/form-data" method="post">
              <div class="encabezado-formulario">
                Formulario para subir imagenes externas al servidor
              </div>
              <div class="form-group">
                ...
                <br><br>
                <input type="text" class="nombre_archivo campos-archivo" placeholder="Nombre de la imagen" id="nombre_imagen_interna" name="nombre_archivo" required>
              ...
              <div class="form-group">
                ...
                <br><br>
                <input type="text" class="nombre_archivo campos-archivo" value="ie" readonly name="tipo_archivo" required >
               ...
               <div class="form-group">
                ...
                <label for="" class="label-archivo campos-archivo" style="color:black; font-weight:900;">Url de la imagen externa a subir <span style="color:red; font-weight:900;">(Este campo es obligatorio que lo llenes)</span> </label>
                <br><br>
