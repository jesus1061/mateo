    ...
    <div class="contenedor-dinamico-admin">
      <div class="contenedor-ajustado">
       <div  id="formulario-blog">
        ...
        <form action="editar_album_datos" method="post" class="formulario">
         ...
         <div class="form-control">
          <label for="" class="label-form">Codigo del albúm</label>
          <br>
          <br>
          <input type="text" class="input-form" id="album"  name="album_id" placeholder="Titulo para el albúm" required value="<?php echo $album['album_id']?>" readonly>
       ...
       <input type="hidden" class="tipo-banner" name="tipo_portada" value="<?php echo $album['tipo_portada']?>">





       <center><input type="button" id="btn-activar-formulario" value="Editar album" style="display:block;"></center> 
     </form>
   </div>
