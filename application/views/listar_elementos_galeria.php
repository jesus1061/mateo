...
$peticion_select = $instancia -> listar_elementos_galeria();
        ...
        <div class="contenedor-tabla">
          ...
          <div class="table" id="resultados">
            ...
            foreach($peticion_select as $elemento){
              ...
              <div class="column-table-banner"><i class="fa fa-pencil btn-editar" id="'.$elemento['contenido_galeria_id'].'" style="color:orange; cursor:pointer; margin:auto;" id="btn-editar"></i><i class="fa fa-trash btn-eliminar-slider" id="'.$elemento['contenido_galeria_id'].'" style="color:red; cursor:pointer; margin:auto;"></i></div>
              ';
            }
          ...
          <form action="editar_elemento_galeria" method="post" style="display: none;">
