      ...
      <div class="contenedor-ajustado">
       ...
       <div class="contenedor-tabla">
        ...
        <div class="table" id="encabezado_tabla">
          <div class="column-table-programa-encabezado encabezado-oculto" style="font-weight: 900;">Nombre Completo del contacto</div>
          <div class="column-table-programa-encabezado encabezado-oculto" style="font-weight: 900;">Correo</div>
          <div class="column-table-programa-encabezado encabezado-oculto" style="font-weight: 900;">Mensaje</div>
          <div class="column-table-programa-encabezado encabezado-oculto" style="font-weight: 900;">Telefono</div>
        </div>
        <div class="table" id="resultados">
          <?php
          foreach($peticion_select as $contacto){
            echo '<div class="column-table-programa-encabezado encabezado-visible" style="font-weight: 900;">Nombre del programa</div>';
            echo '<div class="column-table-programa-contenido"><label style="margin:auto;">'.$contacto['nombre_completo'].'</label></div>
            <div class="column-table-programa-encabezado encabezado-visible" style="font-weight: 900;">Contenido del programa</div>
            <div class="column-table-programa-contenido"><div style="width:90%; color:black; margin:auto; "  >'.$contacto['correo'].'</div></div>
            <div class="column-table-programa-encabezado encabezado-visible" style="font-weight: 900;">Portada del programa</div>
            <div class="column-table-programa-contenido" style="display:table;">'.$contacto['mensaje'].'</div>
            <div class="column-table-programa-encabezado encabezado-visible" style="font-weight: 900;">Opciones</div>
            <div class="column-table-programa-contenido" style="text-align: center">'.$contacto['telefono'].'</div>';
          }
          ?>
